...
import { demo, github } from "../assets"; // ✅ include github icon
...
const ProjectCard = ({
  ...
  return (
    <motion.div
      ...
      className="bg-tertiary p-5 rounded-2xl sm:w-[360px] w-full transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl"
    >
      <div className="relative w-full h-[230px]">
        ...
        {/* ✅ Hover icons for GitHub + Live Demo */}
